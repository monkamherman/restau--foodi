  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Gérer les avis et évaluations des clients</p>
      </div>
            ...
            <Card key={review.id}>
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-base">Utilisateur Anonyme</CardTitle>
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between text-sm text-muted-foreground">
                  <span>ID Avis: {review.id.substring(0, 8)}...</span>
                  <span>ID Plat: {review.dish_id?.substring(0, 8)}...</span>
                </div>
              </CardContent>
            </Card>
          ))
